...
public class HelloWorldController
{
    ...
    //@RequestMapping can handle all types of HTTP requests
    //@GetMapping is used specifically for GET requests.
    //@PostMapping is used specifically for POST requests.
