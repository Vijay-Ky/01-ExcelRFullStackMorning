...
public class MyDemoLoggingAspect
{
    ...
    @Around("execution(* com.mainpackage.service.*.getFortune(..))")
...
//    @After("execution(* com.mainpackage.dao.AccountDAO.findAccounts(..))")
...
//
//    @AfterThrowing(
//            pointcut = "execution(* com.mainpackage.dao.AccountDAO.findAccounts(..))",
//            throwing = "theExc")
