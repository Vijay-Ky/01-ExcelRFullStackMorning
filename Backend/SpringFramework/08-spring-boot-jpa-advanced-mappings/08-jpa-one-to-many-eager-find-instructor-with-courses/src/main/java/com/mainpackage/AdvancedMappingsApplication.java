...
public class AdvancedMappingsApplication
{
	...
	private void createInstructorWithCourses(AppDAO appDAO)
	{
		...
		Instructor tempInstructor =
				new Instructor("Aman", "Public", "aman.public@games.com");
...
/*
This error occurs when you're trying to access a collection (like a List, Set, or Map) in your entity class, but Hibernate hasn't yet loaded that collection from the database.
 */
